...
Pronto
Raw
This makes it easier to adapt existing SmartIR-style code files across multiple controller types.

🧠 Learn Service
AR Smart IR includes a service for learning and saving replacement commands through a Broadlink remote.

Service name:

ar_smart_ir.learn_command
This allows learned commands to be stored into command overrides for an existing AR Smart IR entity.
